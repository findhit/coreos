...
CoreOS.addInitHook(function () {
    ...
    if ( Util.is.Object( cos.config.accounts ) ) {
        cos.config.accounts = Util.Object.map( cos.config.accounts, function ( data ) {
            return Account.createFromProvider( data, cos );
        });
    }
...
var Account = Class.extend({
    ...
    statics: {
        ...
        createFromProvider: function ( data, cos ) {

            if ( Util.isnt.Object( data ) ) {
                throw new TypeError( "invalid data attribute" );
            }
    ...
    nodeDestroy: function () {
        throw new TypeError( "please create your account nodeDestroy method" );
    },

    nodeSyncFirewallRules: function () {
        throw new TypeError( "please create your account nodeSyncFirewallRules method" );
    },
